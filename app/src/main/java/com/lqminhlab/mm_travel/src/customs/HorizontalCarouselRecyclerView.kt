...
class HorizontalCarouselRecyclerView(context: Context, attrs : AttributeSet) : RecyclerView(context, attrs){
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.colorAccent) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.colorAccentLight) }
